      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <ContactInfoCard
            ...
            title="Email"
            description="temel.dev1@gmail.com"
            href="mailto:temel.dev1@gmail.com"
          />
          <ContactInfoCard
          ...
          <ContactInfoCard
            icon={<svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>}
            title="X (Twitter)"
            description="@temelbusiness"
